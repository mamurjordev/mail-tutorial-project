    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h1>Laravel Google Translate Example - Mamurjor IT </h1>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-4">
                        <select class="form-select changeLang">
                            ...
                            <option value="fa" {{ session()->get('locale') == 'fa' ? 'selected' : '' }}>Persian</option>
                            <option value="ar" {{ session()->get('locale') == 'ar' ? 'selected' : '' }}>Arabic</option>
                           
                        </select>
                    </div>
                </div>
                <h3>{{ GoogleTranslate::trans('hadi is a bad boy ', app()->getLocale()) }}</h3>
